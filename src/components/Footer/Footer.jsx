    ...
    return (
        <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
                <div>
                    <Link className="flex-none text-xl font-semibold text-black dark:text-slate-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" to={ config.site.url } aria-label="Brand">{ config.site.titel }</Link>
                </div>

                ...
                <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-4 font-medium text-gray-900">Manufacturer</th>
                            <th scope="col" className="px-6 py-4 font-medium text-gray-900">Assembly</th>
                    ...
                    <tbody>
                        { product.map( ( machine, index ) => (
                            <tr key={ index }>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">{ machine.manufacturer }</td>
                                <td className="px-6 py-4 whitespace-nowrap">{ machine.assembly }</td>
